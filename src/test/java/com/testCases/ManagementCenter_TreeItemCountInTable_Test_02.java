...
import com.pageObjects.ManagementCenter__TreeItemCountInTable_Page;
...
public class ManagementCenter_TreeItemCountInTable_Test_02
		extends BaseClass {
	...
	public void ManagementCenter_TreeItemCountInTable(@Optional String username, @Optional String password, String login) throws InterruptedException, Exception {// This is for TestNG.xml file
		...
		ManagementCenter__TreeItemCountInTable_Page TreeItemCountInTable = new ManagementCenter__TreeItemCountInTable_Page(driver);
		TreeItemCountInTable.TreeItemCountInTable();
